...
@property(nonatomic, copy)NSDictionary<Optional>* geo;
@property(nonatomic, strong)UserModel<Optional>* user;
@property(nonatomic, strong)WeiboModel<Optional>* retweeted_status;
@property(nonatomic, assign)int reposts_count;
@property(nonatomic, assign)int comments_count;
@property(nonatomic, assign)int attitudes_count;
@property(nonatomic, strong)NSArray<Optional>* pic_ids;

@property(nonatomic, strong)NSArray<Optional>* pic_urls;    //微博多图的url数组
